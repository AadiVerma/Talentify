...
export async function sendContactUsEmail({ name, email, phone, message }) {
    try {
            ...
            html: `
                ...
                <head>
                    ...
                    <style>
                        ...
                        /* Add a nice hover effect for potential interactive elements */
                        .button {
                ...
                <body>
                    <div class="wrapper">
                        <div class="header">
                            <!-- Replace this with an actual hosted image URL for your logo -->
                        ...
                        <div class="footer">
                            <p class="footer-text">This message was sent via Talentify Contact Form</p>

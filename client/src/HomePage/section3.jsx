...
export default function Section3() {
    return (
        <div className="flex flex-col relative items-center  p-16 min-h-[680px] bg-[#030b1c] text-gray-300 ss4 rounded-3xl">
            <h1 className="text-5xl">Start Scaling your Hiring</h1>
            <h2 className="text-5xl mt-2 ">Efforts with Ease</h2>
            <h1 className="text-xl  mt-2">Effortlessly manage your hiring process and quickly connect with top talent to scale your team.</h1>
